...
const CategorySection = () => {
  ...
  if (selectedCategory) {
    ...
    return (
      <div className="p-6 flex justify-center items-center min-h-[80vh] bg-white animate__animated animate__fadeIn">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex flex-col justify-between w-full">
              ...
              <div className="flex justify-end mt-4">
                <button
                  className="bg-green-600 text-white px-5 py-2 rounded-lg shadow hover:bg-green-700 transition-all duration-300 hover:-translate-y-1"
    ...
    <section className="my-10 max-w-6xl mx-auto px-4 bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        {categories.map((cat) => (
          <div
            key={cat.name}
            className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] animate__animated animate__fadeIn cursor-pointer"
          >
            <img
              src={cat.image}
              alt={cat.name}
            ...
            <div className="p-4 flex flex-col items-center text-center">
              ...
              <button
                ...
                className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-all duration-300 hover:-translate-y-1"
              >
                See More
              </button>
            </div>
